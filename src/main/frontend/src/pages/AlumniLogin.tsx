...
const AlumniLogin = () => {
  ...
  const [selectedValue, setSelectedValue] = React.useState<string>("Alumni");
      ...
      <div className="container">
        <div className="stundetLoginMainCont">
          <div className="loginContainer">
            <h1 className="studentLoginTitle" style={{textAlign: "center"}}>Alumni Login</h1>
            <form className="loginFormContainer">
              {isLoding ? (
                ...
                <>
                  ...
                  <p>If you're an existing student, <a style={{textDecoration: "none"}} href="https://documents.daiict.ac.in/student/login">Login here</a></p>
                </>
              )}
            </form>
          </div>
