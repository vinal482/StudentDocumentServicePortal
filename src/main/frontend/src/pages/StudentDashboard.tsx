  ...
  const getSelectedDocuments = () => {
    ...
    for (let i = 0; i < data.length; i++) {
      if (selectedRows.includes(i)) {
        if(numberOfCopies[i] == 0 || numberOfCopies[i] == null) {
        ...
        const doc = {
          ...
          noOfCopies: numberOfCopies[i] || 1, // handle missing values
        };
                        ...
                        {data.map((row, index) => (
                          <tr key={row.uniqueId || index}>
                            <td>
                              <input
                                type="checkbox"
                                style={{ margin: "10px 0 10px 15px", height: "15px", width: "15px" }}
                            ...
                            <td>
                              <p style={{ margin: "10px 5px 10px 10px" }}>
                                {row.documentName}
                              </p>
                            </td>
                            <td>
